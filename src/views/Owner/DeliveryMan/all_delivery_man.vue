...
const getDeliveryPersonnel = async () => {
  let response = await axios.get("/api/deliveryPersonnel");
  deliveryPersonnel.value = response.data;
};
//---------------------------------------------------
const deleteDeliveryPersonnel = (id) => {
  axios.delete(`/api/deliveryPersonnel/${id}`).then(() => {
    notify({
      title: "Deliver Personnel  Deleted",
      type: "success",
    });
    getDeliveryPersonnel();
  });
  ...
  <div class="container">
    <div class="table-box">
      ...
      <table id="customers">
        ...
        <tbody v-for="item in deliveryPersonnel" :key="item.id">
          ...
          <tr>
            ...
            <td style="text-align: center;">
              ...
              <button class="edit-btn">
                <router-link :to="{ name: 'edit-delivery-personnel', params: { id: item.id } }">Edit</router-link>
              </button>
            </td>
          </tr>
        </tbody>
