  ...
  <div class="container">
    <div class="table-box">
      ...
      <table id="customers">
        ...
        <tbody v-for="item in payments" :key="item.id">
          <Modal :show="deleteVisibleId === item.id" @close="closeModalDelete">
            <div id="myModal" style="text-align: center;">
              ...
              <div class="modal_footer" style="padding: 20px;">
                ...
                <button @click="deletePayments(item.id)" type="button" style="background: #f15e5e;">Delete</button>
              </div>
            </div>
          </Modal>
          <tr>
